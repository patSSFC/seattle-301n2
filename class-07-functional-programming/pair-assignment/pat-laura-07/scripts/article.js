// DONE: PAT-LAURA Wrap the entire contents of this file in an IIFE.
...
(function(module) {
  ...
  // DONE: PAT-LAURA - Refactor this function, and provide it with a parameter of a callback function
  ...
  Article.fetchAll = function(initPage) {
  ...
  // DONE: PAT+LAURA Chain together a `map` and a `reduce` call to get a rough count of all words in all articles.
